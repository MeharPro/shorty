...
import brainrotNode from '../api/brainrot-node.js';
...
import prepareBrainrotGameplay from '../api/prepare-brainrot-gameplay.js';
import prepareBrainrotRemoteGameplay from '../api/prepare-brainrot-remote-gameplay.js';
import renderManifest from '../api/render-manifest.js';
import resolveGameplay from '../api/resolve-gameplay.js';
import signCloudinary from '../api/sign-cloudinary.js';
import transcribeVideo from '../api/transcribe-video.js';
import workflowExport from '../api/workflow-export.js';
...
const routes = new Map([
  ...
  ['/api/brainrot-node', brainrotNode],
  ...
  ['/api/health', health],
  ['/api/prepare-brainrot-gameplay', prepareBrainrotGameplay],
  ['/api/prepare-brainrot-remote-gameplay', prepareBrainrotRemoteGameplay],
  ['/api/render-manifest', renderManifest],
  ['/api/resolve-gameplay', resolveGameplay],
  ['/api/sign-cloudinary', signCloudinary],
  ['/api/transcribe-video', transcribeVideo],
  ['/api/workflow-export', workflowExport],
]);
