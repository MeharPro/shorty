...
export const GAMEPLAY_FILE = path.resolve(
  process.cwd(),
  'src/assets/Subway Surfers Gameplay No Copyright 4K - Orbital - No Copyright Gameplay (720p, h264, youtube).mp4'
);
export const GAMEPLAY_DERIVED_FILE = path.join(BRAINROT_CACHE_DIR, 'subway-surfers-demo.mp4');
export const GAMEPLAY_PUBLIC_ID = 'shorty/brainrot/subway-surfers-demo';
...
export async function ensureBrainrotGameplayAsset({ cloudName, apiKey, apiSecret }) {
  ...
  if (!cached) {
    ...
    await uploadFileToCloudinary({
      ...
      fileName: 'subway-surfers-demo.mp4',
